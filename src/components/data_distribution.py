...
def data_distribution(filtered_df, df):
    ...
    # renderiza o gráfico de barras de atividades por operador
    with col6:
        df_counts = (
            filtered_df["NOME"].value_counts().reset_index()
        )  # conta quantas vezes cada operador ("NOME") aparece no DataFrame
